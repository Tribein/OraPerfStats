...
public class SysCollector {
    ...
    private static final String ORADBFILESSIZEQUERY = 
            "select 0 file_type,file_id,file_name,round(bytes/1024/1024) sizemb,autoextensible,round(maxbytes/1024/1024) maxmb,tablespace_name from dba_data_files " +
            "union all " +
            "select 1 file_type,file_id,file_name,round(bytes/1024/1024) sizemb,autoextensible,round(maxbytes/1024/1024) maxmb,tablespace_name from dba_temp_files";    
